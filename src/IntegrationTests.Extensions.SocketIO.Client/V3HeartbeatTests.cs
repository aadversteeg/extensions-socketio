...
public class V3HeartbeatTests : V3IntegrationTestBase
{
    public V3HeartbeatTests(SocketIOV2ServerFixture fixture) : base(fixture) { }

    [Fact(DisplayName = "V3H-001: Client sends ping and OnPong fires after server pong response")]
    public async Task V3H001()
    {
    ...
    [Fact(DisplayName = "V3H-002: Connection stays alive through multiple heartbeat cycles")]
    public async Task V3H002()
    {
        if (ShouldSkip) return;
