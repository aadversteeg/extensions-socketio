...
/// <summary>
/// xUnit fixture that manages a Node.js Socket.IO test server process.
/// </summary>
public class SocketIOServerFixture : IAsyncLifetime
{
    ...
    {
        // Navigate from the output directory up to the repository root, then into test/server.
        ...
        var serverDir = Path.Combine(dir, "test", "server");
        ...
        var outputServerDir = Path.Combine(baseDir, "server");
